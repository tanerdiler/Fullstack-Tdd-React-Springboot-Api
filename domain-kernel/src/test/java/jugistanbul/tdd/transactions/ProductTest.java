...
public class ProductTest {
    ...
    public void should_throw_PropertyRequiredException_if_no_price_specified () {
        var ex = assertThrows(PropertyRequiredException.class, ()-> Product.aNew().name("USB Disc").get());
    ...
    public void should_throw_PropertyRequiredException_if_no_name_specified () {
        var ex = assertThrows(PropertyRequiredException.class, ()-> Product.aNew().price(Money.of(200d)).get());
